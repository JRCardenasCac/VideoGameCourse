...
var Juego = {
  preload: function () {
    ...
    juego.load.image("carro", "img/car1.png");
    ...
    juego.load.audio("chargeSound", "sounds/disparo.mp3");
  ...
  create: function () {
    ...
    colisionSound.volume = 0.2;
    chargeSound = juego.add.audio("chargeSound");
